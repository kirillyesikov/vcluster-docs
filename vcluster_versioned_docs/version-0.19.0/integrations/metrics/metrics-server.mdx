...
Alternatively, install the metrics server using a single-file manifest located below. 
...
```
:::info Deploy the metrics server using a single-file yaml manifest with metrics_patch already applied [metrics.yaml] (https://github.com/kirillyesikov/vcluster-docs/blob/main/vcluster_versioned_docs/version-0.19.0/integrations/metrics.yaml) :::
