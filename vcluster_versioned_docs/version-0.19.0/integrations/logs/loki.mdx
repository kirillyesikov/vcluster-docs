...
Install [Prometheus](../metrics/prometheus/) before installing Loki.

### Add the Helm repo and install Loki:
```
helm repo add loki https://grafana.github.io/loki/charts
helm upgrade --install loki -f loki_values.yaml --namespace=monitoring grafana/loki-stack --create-namespace
```
